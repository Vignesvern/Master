...
3.Our project is about a mobile detection robot powered by Arduino board and has dimensions to fit in the cross-section of a pipe. It comes with a 360 degree sensor module that can detect any anomaly in the pipe’s internal surface(leak).
